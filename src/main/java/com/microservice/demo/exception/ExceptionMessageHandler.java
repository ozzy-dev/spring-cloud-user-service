...
import com.microservice.demo.dto.DefaultExceptionMessageDto;
...
public class ExceptionMessageHandler {
    ...
    private Optional<DefaultExceptionMessageDto> getMessageFromAnnotation(Method method) {
        com.microservice.demo.annotation.DefaultExceptionMessage defaultExceptionMessage = method.getAnnotation(com.microservice.demo.annotation.DefaultExceptionMessage.class);
